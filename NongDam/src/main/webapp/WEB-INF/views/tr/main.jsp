			...
			<form method="get">
				<div class="input-group">
					...
					<select class="btn btn-outline-secondary dropdown-toggle"
						name="type">
						<option class="dropdown-item" value="tr_title"
							${cri.type == 'tr_title' ? 'selected' : ''}>제목</option>
						<option class="dropdown-item" value="user_nickname"
							${cri.type == 'user_nickname' ? 'selected' : ''}>작성자</option>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<p class="card-text">
										...
										<span class="title-overflow-1">작성일 <fmt:formatDate
												value="${li.tr_time }" pattern="YYYY-MM-dd " /></span>
									</p>
					...
					<ul class="pagination">
						...
						<c:if test="${pageCre.next }">
							<li class="page-item"><a class="page-link text-secondary"
								href="${pageCre.endPage+1}">&raquo;</a></li>
						</c:if>
